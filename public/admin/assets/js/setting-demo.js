...
function customCheckColor() {
  ...
  if (logoHeader !== "white") {
    $(".logo-header .navbar-brand").attr("src", "asset('assets/images/logo-principal-white.png')");
  } else {
    $(".logo-header .navbar-brand").attr("src", "asset('assets/images/logo-principal.png')");
  }
}
