<header class="main-header header-style-three">
        ...
        <div class="auto-container">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="right-box d-flex align-items-center flex-wrap">
                    ...
                    <nav class="main-menu show navbar-expand-md"></nav>
                    ...
                    <!-- BOTONES -->
                    <div class="button-box" style="display:flex; gap:12px;">
                        <a class="btn-cotizar" href="{{ route('admin.login') }}">
                            <i class="fa-solid fa-user"></i> Panel Clientes
                        </a>
                        <a class="btn-tienda" href="{{ route('mantenimiento') }}">
                            <i class="fa-solid fa-store"></i> Tienda virtual
                        </a>
                    </div>
    ...
    <div class="mobile-menu">
        ...
        <nav class="menu-box">
            <div class="nav-logo"><a href="index.html"><img src="{{ asset('assets/images/logo-principal.png') }}"
                        alt="CODWARE" title="CODWARE"></a>
            </div>
